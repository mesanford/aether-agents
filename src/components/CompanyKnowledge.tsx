  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50/30 overflow-hidden">
      ...
      <div className="px-8 py-6 bg-white border-b border-slate-100 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Company Knowledge</h1>
          <p className="text-sm text-slate-500 mt-1">
            General information about your business that all agents use to understand your brand.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            <div className="relative group">
              <div className="w-32 h-32 bg-white rounded-2xl border border-slate-200 shadow-sm flex items-center justify-center p-6 overflow-hidden">
                <img 
            ...
            <div className="flex items-center gap-2 group">
              {isEditingName ? (
                <input 
                  ...
                  className="text-2xl font-bold text-slate-900 bg-transparent border-b-2 border-brand-500 outline-none text-center"
                />
              ) : (
                <>
                  ...
                  <button 
                    ...
                    className="p-1 opacity-0 group-hover:opacity-100 transition-opacity text-slate-400 hover:text-slate-600"
                  >
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-medium uppercase tracking-wider mt-0.5">Help your AI understand and represent your business accurately</p>
                </div>
              </div>
              <textarea 
                value={description}
                onChange={(e) => setDescription(e.target.value)}
                className="w-full h-48 p-6 bg-slate-50 border border-slate-100 rounded-2xl text-[15px] text-slate-700 leading-relaxed focus:ring-2 focus:ring-brand-500/10 focus:border-brand-500 outline-none transition-all resize-none"
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-medium uppercase tracking-wider mt-0.5">Describe your ideal customers and target audience</p>
                </div>
              </div>
              <textarea 
                value={targetCustomers}
                onChange={(e) => setTargetCustomers(e.target.value)}
                className="w-full h-32 p-6 bg-slate-50 border border-slate-100 rounded-2xl text-[15px] text-slate-700 leading-relaxed focus:ring-2 focus:ring-brand-500/10 focus:border-brand-500 outline-none transition-all resize-none"
