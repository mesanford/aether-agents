...
export async function buildAiTaskExecutionResult({
  ...
  const prompt = [
    ...
    "",
    `CRITICAL INSTRUCTION: You are in "Summary/Research Mode". You do NOT have access to tools (CRM, Email, etc.) during this background execution step.`,
    `Do NOT claim you have added leads, sent emails, or scheduled posts. instead, produce an artifact that summarizes what you RESEARCHED or what you RECOMMEND doing next.`,
